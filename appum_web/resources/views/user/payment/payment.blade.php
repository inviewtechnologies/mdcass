                                ...
                                <div class="profile-right">
                                    ...
                                    <div class="profile-right-content payments-section">
                                            ...
                                            <div class="col-md-6">
                                                <div class="wallet-money-inner row m-0">
                                                    <div class="foodie-money pull-left">
                                                        <span>@lang('user.create.foodie_money') : {{currencydecimal(Auth::user()->wallet_balance)}}</span>
                                                    </div>
                                                    <div class="statement pull-right">
                                                       <!--  <a href="#statement-modal" class="theme-link state-link" data-toggle="modal" data-target="#statement-modal">View Statement</a> -->
                                                         ...
                                                         <a href="#" onclick="$('#addcard-sidebar').asidebar('open')">
                                                            <button class="address-btn">@lang('home.payment.add_card')</button>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="saved-cards">
                                            <h6>@lang('user.create.saved_cards')</h6>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="saved-cards-box row m-0">
                                                        ...
                                                        <div class="saved-cards-box-right pull-right">
                                                           ...
                                                           <a href="javascript:void(0);" class=" address-btn add-new" onclick="addmoney({{$card->id}});">@lang('user.create.add_money_in_wallet')</a>
                                                        </form>
                                                        </div>
                                                    ...
                                                    <div class="saved-cards-box row m-0">
                                                        ...
                                                        <div class="saved-cards-box-right pull-right">
                                                           <form action="{{route('card.destroy',$card->id)}}" method="POST" class="pull-right">
                                                            ...
                                                            <input type="hidden" name="_method" value="DELETE">
                                                            <input type="hidden" name="card_id" value="{{$card->card_id}}">
                                                            <button onclick="return confirm('Are you sure?')" type="submit" class="card-delete theme-link show-btn" >@lang('user.create.delete')</button>
                                                            <a href="#" class="address-btn add-new" onclick="addmoney({{$card->id}});">@lang('user.create.add_money_in_wallet')</a>
                                            ...
                                            @endforelse
                                                ...
                                                <!-- <a href="#" class="add-card-box row m-0" onclick="$('#addcard-sidebar').asidebar('open')">
                                                        ...
                                                        <div class="add-card-right">
                                                            <h6 class="address-tit">@lang('home.payment.add_new')</h6>
                                                           
                                                            <button class="address-btn add-new">@lang('home.payment.add_card')</button>
                                                        </div>
                                                </a>  -->
                                            </div>
                                        </div>
 ...
 <!-- Add Card Starts -->
    <div class="aside right-aside location" id="addcard-sidebar">
        <div class="aside-header">
            ...
            <h5 class="aside-tit">@lang('user.create.enter_your_card_details')</h5>
        </div>

...
class CreateOrderInvoicesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('order_invoices', function (Blueprint $table) {
            ...
            $table->integer('promocode_id')->default(0)->nullable();
            $table->double('promocode_amount',10,2)->default(0)->nullable();
            $table->double('payable',10,2)->default(0);
            $table->double('tax',10,2)->default(0);                     // Tax = (Gross - Discount) * Tax / 100
            $table->double('net',10,2)->default(0);                     // Net = Gross - Discount + Tax
            $table->double('total_pay',10,2)->default(0);
            $table->double('tender_pay',10,2)->default(0); 

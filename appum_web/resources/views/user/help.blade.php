                                    ...
                                    <div class="profile-address">
                                                ...
                                                <div class="saved-address-box row m-0">
                                                    ...
                                                    <div class="save-add-right ">
                                                        ...
                                                        <div data-id="{{$Address->id}}">
                                                            ...
                                                            <a href="#" class="theme-link myaddress show-btn" onclick="$('#location-sidebar').asidebar('open')">@lang('user.create.edit')</a>
                                                            
                                                            <button class="theme-link show-btn" onclick="return confirm('Do You want To Remove This Address?');" form="resource-delete-{{ $Address->id }}">@lang('user.create.delete')</button>
                                        ...
                                        <a href="#" class="address-cmn-box add-new-address row m-0" onclick="$('#location-sidebar').asidebar('open')">
                                            ...
                                            <div class="address-box-right">
                                                <h6 class="address-tit">@lang('user.create.add_new_address')</h6>
                                                <p class="address-txt">{{Session::get('search_loc')}}</p>
                                                <button class="address-btn">@lang('user.create.add_new')</button>
                                            </div>
                                        </a>
                                    </div>
                                        </div>
    ...
    <div class="aside location" id="location-sidebar">
        ...
        <div class="aside-contents">
            <form action="{{route('useraddress.store')}}" method="POST" id="comon-form" class="common-form">
                ...
                <button class="add-address-btn">@lang('user.create.save_proceed')</button>
            </form>
        </div>
    </div>

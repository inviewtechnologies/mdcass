                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(Setting::get('DEMO_MODE')==1)
                                            ...
                                            <button   class="table-btn btn btn-icon btn-danger" form="resource-delete-{{ $User->id }}" ><i class="fa fa-trash-o" onclick="return confirm('Are you sure you want to delete this dispute user?');"></i></button>
                                        @endif

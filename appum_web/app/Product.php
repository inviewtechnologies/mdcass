...
*/
     ...
     * Get the list of all categories along with variants and images.
     */
    public function scopeShow($query,$prod_id = NULL)
    {
        return $query->where('id',$prod_id)->with('productcuisines','images','featured_images', 'prices', 'variants', 'variants.images', 'variants.prices','categories','shop.cuisines','addons')->get();
    }

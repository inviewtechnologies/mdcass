                            ...
                            @forelse($Users as $key=>$User)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button   class="table-btn btn btn-icon btn-danger" form="resource-delete-{{ $User->id }}" onclick="return confirm('Are you sure you want to delete this delivery boy?');" ><i class="fa fa-trash-o"></i></button>

                    ...
                    <tr>
                        ...
                        <td>
                            @if(Setting::get('DEMO_MODE')==1)
                             ...
                             @endif
                            <button  class="table-btn btn  btn-danger" onclick="return confirm('Do You want To Remove This Dispute?');" form="resource-delete-{{ $Help->id }}" ><i class="fa fa-trash-o"></i></button>

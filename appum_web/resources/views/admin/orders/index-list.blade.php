            ...
            <div class="form-group col-xs-12 mb-2">
                ...
                <div class="form-group col-xs-6 ">
                    ...
                    <select id="user_name" name="pm" class="form-control">
                        ...
                        <option value="wallet" @if(Request::get('pm')=='wallet') selected  @endif  >Wallet</option>
                        <option value="stripe" @if(Request::get('pm')=='stripe') selected  @endif  >Credit Card</option>
                    </select>
                </div>
            </div>
...
@endsection
@section('styles')
<link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/plugins/bootstrap-datepicker/css/bootstrap-datepicker.min.css')}}">
@endsection
@section('scripts')

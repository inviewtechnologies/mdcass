                        ...
                        <div class="search-head-left col-xs-10">
                            <form class="search-form">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="q" id="serarch_text" value="{{Request::get('q')}}" class="form-control" placeholder="Search">
                                </div>
                            </form>
                        </div>
                        <!-- Search Head Left Ends -->
                        <!-- Search Head Right  Starts -->
                        <div class="search-head-right col-xs-2" id="hide_esc" style="display: none;">
...
<script type="text/javascript">
    @if(Request::get('q'))
        $("#hide_esc").show();
    @endif
    $("#serarch_text").on('keyup', function(){
        var stext=$(this).val();
